...
public class CameraConnectionFragment extends Fragment implements TFConstants {
    ...
    public void onResume() {
        ...
        /**
         * 当屏幕关闭再打开屏幕时，SurfaceTexture早已经available了，并且onSurfaceTextureAvailable这个不会被调用。
         * 在这个情况下我们可以从这里open一个Camera并start preview(否则，我们需要等待surface准备好在SurfaceTextureListener的回调)
         */
    ...
    private void setUpCameraOutputs() {
        ...
        try {
           ...
           // 危险,尝试使用太大的预览尺寸可能超过相机总线的带宽限制，导致捕获到垃圾数据。
            previewSize =
                    chooseOptimalSize(
