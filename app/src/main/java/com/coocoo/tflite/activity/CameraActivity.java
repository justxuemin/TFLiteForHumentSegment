...
import com.coocoo.tflite.fragment.CameraConnectionFragment;
import com.coocoo.tflite.utils.ImageUtils;

import java.nio.ByteBuffer;

public abstract class CameraActivity extends AppCompatActivity implements ImageReader.OnImageAvailableListener, Camera.PreviewCallback, TFConstants {
    ...
    protected void showInference(String s) {
        inference.setText(s);
    }
}
